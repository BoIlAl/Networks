...
def windowsize_plot(window_sizes, timeout, probability, max_num_messages, img_save_dst):
    ...
    draw_plot(window_sizes, num_GBN, num_SR, 'GBN SR num ws', 'window_size', 'num', img_save_dst)
    draw_plot(window_sizes, time_GBN, time_SR, 'GBN SR time ws', 'window_size', 'time', img_save_dst)
...
def probability_plot(window_size, timeout, probabilities, max_num_messages, img_save_dst):
    ...
    draw_plot(probabilities, num_GBN, num_SR, 'GBN SR num prob', 'probability', 'num', img_save_dst)
    draw_plot(probabilities, time_GBN, time_SR, 'GBN SR time prob', 'probability', 'time', img_save_dst)
